...
export class Side {
	...
	chooseMove(
		...
		if (pokemon.maybePartialTrappingLock) {
			...
			console.log("vrej " + pokemon.volatiles);
			console.log(typeof pokemon.volatiles)
			console.log("oogle boogle" + pokemon.volatiles['partiallytrapped']);
			console.log("oogle boogle" + pokemon.volatiles[0]);
			if (!pokemon.volatiles['partiallytrapped'] && !pokemon.volatiles['partialtrappinglock'] && !pokemon.volatiles['wraplock']) {
